...
class ECG(Dataset):
    def __init__(self, normal_label, anomalous_label,path):
        ...
        from DataPreparationScripts import ECG_Script as ECG_Handler
        # get all the data
        [self.normal_data, self.normal_data_label, self.anomalous_data,
         self.anomalous_data_label] = ECG_Handler.prepare_ECG(self.normal, self.anomalous,self.path)
